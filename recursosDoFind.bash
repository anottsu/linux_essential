...
sudo find /etc -maxdepth 2 -iname *.conf    // sudo(root) find(comando) /etc (a partir da pasta etc) -maxdepth 2(no max 2 pastas de recursividade) -name(nome do arquivo) *.conf(tudo que contenha .conf)
